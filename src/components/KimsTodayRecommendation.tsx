  ...
  const items: RecommendationItem[] = [
    {
      ...
      tacticalPlan: '시초가 부근 분할 매수 진입 후, 5거래일 이내 단기 돌파 파동 시 보유 비중의 50%를 $1,120 부근에서 선제 익절하여 수익 확보. 나머지 50% 잔량은 2개월간 $1,200 돌파를 타겟으로 끌고 가며 포트폴리오 메인 성장 동력으로 삼는 전략이 극도로 유리.',
    },
    {
      rank: 2,
      rankText: '2nd',
